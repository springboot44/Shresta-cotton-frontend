...
const About = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-100">
      {/* Main Heading */}
      <h2 className="text-5xl font-extrabold text-center mb-12 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-500 shadow-xl p-6 rounded-lg bg-white">
        About Stresta Cotton Mill
      </h2>
      
      {/* Introduction Section */}
      <div className="mb-12 bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-blue-500">
      ...
      {/* History Section */}
      <div className="mb-12 bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-purple-500">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 p-4">
          Our History
        </h3>
        <p className="text-lg text-gray-800 p-6">
      ...
      {/* Mission Section */}
      <div className="mb-12 bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-teal-500">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-cyan-500 p-4">
          Our Mission
        </h3>
        <p className="text-lg text-gray-800 p-6">
      ...
      {/* Values Section */}
      <div className="mb-12 bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-yellow-500">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-orange-500 p-4">
          Our Values
        </h3>
        <ul className="list-disc list-inside space-y-4 text-lg text-gray-800 p-6">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden border-t-4 border-red-500">
        <h3 className="text-3xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-yellow-600 p-4">
          Why Choose Us?
        </h3>
        <p className="text-lg text-gray-800 p-6">
